...
static void lcd_prepare_menu()
{
    ...
    MENU_ITEM(gcode, MSG_CALIBRATE, PSTR("G33"));
#endif
#ifdef ENABLE_AUTO_BED_LEVELING
    MENU_ITEM(gcode, MSG_AUTO_BEDLEVEL, PSTR("G29"));
    MENU_ITEM_EDIT(bool, MSG_BEDLEVEL, &enable_auto_bed_leveling);
#endif
...
static void lcd_control_motion_menu()
{
    START_MENU();
    MENU_ITEM(back, MSG_CONTROL, lcd_control_menu);
    MENU_ITEM_EDIT(float32, MSG_ZPROBE_ZOFFSET, &zprobe_zoffset, -1.00, 1.00);
