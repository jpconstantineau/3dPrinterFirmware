...
// #define RAMPS_V_1_0
  ...
  #define LARGE_FLASH true
    ...
    #define FAN_PIN            -1 //9 FLSUN original// (Sprinter config) disabled in order to set Auto Fan
  #else
  ...
  #define PS_ON_PIN            -1   //12 does not exist on FLSUN
    ...
    #define HEATER_1_PIN       -1 // 7 on FLSUN MKS Base
  #else
